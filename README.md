...
研究室の勉強会・輪講・ゼミ向けに、テキストや論文などの PDF から **わかりやすい解説記事とスライドを自動生成** する MkDocs サイトです。
...
- PDF（教科書・論文）から解説記事・Marpスライド・Mermaid図を自動生成
